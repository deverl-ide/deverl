...
init(Config) ->
  ...
  wxMenu:append(File, ?MENU_ID_SAVE_PROJECT, "Save Project"),
  ...
  ets:insert(TabId, [
    ...
    {?wxID_CLOSE_ALL, {doc_manager,close_all,[]}},
		{?MENU_ID_CLOSE_PROJECT, {doc_manager,close_active_project,[]}},
    {?wxID_EXIT, {}},
    ...
    {?MENU_ID_INDENT_GUIDES, {editor_ops,set_indent_guides,[View]}},		
		...
		{?MENU_ID_LC_SEL, {editor_ops,transform_selection,[]}, [{send_event, true}]},			
		{?MENU_ID_FOLD_ALL, {}},
		{?MENU_ID_UNFOLD_ALL, {}},
