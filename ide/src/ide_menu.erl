...
init(Config) ->
  ...
  ets:insert(TabId, [
    ...
    {?MENU_ID_FULLSCREEN, {}},
    {?MENU_ID_HIDE_TEST, {doc_manager,toggle_pane,[test]}, [{update_label,2}] },
    {?MENU_ID_HIDE_UTIL, {doc_manager,toggle_pane,[util]}, [{update_label,2}] },
    {?MENU_ID_MAX_EDITOR, {doc_manager,toggle_pane,[editor]}},
    {?MENU_ID_MAX_UTIL, {doc_manager,toggle_pane,[maxutil]}},
