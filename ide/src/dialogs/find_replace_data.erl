%% Create the data to send the the find_replace_dialog when started.
...
-export_type([find_replace_data/0]).
-type find_replace_data() :: pid().
...
-spec set_options(find_replace_data(), integer()) -> 'ok'.
