...
init(Config) ->
    ...
    ets:insert(TabId,{?MENU_ID_HIDE_TEST, "New", "Create a new file.", {aui,toggle_pane,[test]}}),
    ets:insert(TabId,{?MENU_ID_HIDE_UTIL, "New", "Create a new file.", {aui,toggle_pane,[util]}}),
    ets:insert(TabId,{?MENU_ID_MAX_EDITOR, "New", "Create a new file.", {aui,toggle_pane,[editor]}}),
    ets:insert(TabId,{?MENU_ID_MAX_UTIL, "New", "Create a new file.", {aui,toggle_pane,[maxutil]}}),
